...
export default function About() {
  return (
    <section id="sobre" className="py-16 sm:py-20 md:py-24 bg-section-gold-light overflow-hidden">
      <div className="container-site px-4 sm:px-6">
          ...
          <ParallaxSection speed={0.3} direction="down">
            <FadeInView direction="right" delay={0.3} className="relative">
              <ParallaxImage
                ...
                containerClassName="aspect-square rounded-3xl shadow-card"
                speed={0.4}
              />
              {/* Decorative elements */}
              <motion.div 
        ...
        <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {values.map((value, index) => (
            <ParallaxSection key={value.title} speed={0.1 + index * 0.05}>
