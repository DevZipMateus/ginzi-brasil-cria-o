...
export default function Product() {
  return (
    <section id="produto" className="py-16 sm:py-20 md:py-24 bg-section-gold-light overflow-hidden">
      <div className="container-site px-4 sm:px-6">
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          {/* Product visual */}
          <ParallaxSection speed={0.25} direction="down" className="order-2 lg:order-1">
            <FadeInView direction="left" className="relative">
              <ParallaxImage
                ...
                containerClassName="aspect-square rounded-2xl sm:rounded-3xl shadow-card"
                speed={0.4}
              />
          ...
          {/* Content */}
          <ParallaxSection speed={0.15} direction="up" className="order-1 lg:order-2">
            <FadeInView direction="right" delay={0.2} className="space-y-6 sm:space-y-8">
              <div>
